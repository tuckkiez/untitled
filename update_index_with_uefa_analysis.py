#!/usr/bin/env python3
"""
🚀 Update Index with UEFA Analysis - July 17-18, 2025
...
def load_analysis_data():
    ...
    try:
        with open('uefa_competitions_analysis.json', 'r', encoding='utf-8') as f:
            return json.load(f)
...
def generate_html_output(analysis_data):
    ...
    <head>
        <meta charset="UTF-8">
        <title>UEFA Competitions Analysis - July 17-18, 2025</title>
        <style>
            body {{
    ...
    <body>
        <h1>UEFA Competitions Analysis - July 17-18, 2025</h1>
...
def update_index_html(analysis_data):
    ...
    try:
        ...
        uefa_section = f"""
        <!-- UEFA Competitions Analysis Section -->
        <div class="section-container">
            <div class="section-header">
                <h2>🇪🇺 UEFA Competitions Analysis - July 17-18, 2025</h2>
        ...
        <!-- End UEFA Competitions Analysis Section -->
        """
        
        # ตรวจสอบว่ามีส่วน UEFA อยู่แล้วหรือไม่
        if "<!-- UEFA Competitions Analysis Section -->" in html_content:
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 Update Index with UEFA Analysis - July 17-18, 2025")
    print("=" * 60)
    
    # รันสคริปต์วิเคราะห์ข้อมูล
    print("\n📊 กำลังรันสคริปต์วิเคราะห์ข้อมูล...")
    os.system("python analyze_uefa_competitions.py")
