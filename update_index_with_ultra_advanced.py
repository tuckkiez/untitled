#!/usr/bin/env python3
"""
🚀 Update Index with Ultra Advanced Analysis - July 17-18, 2025
อัปเดตหน้า index.html ด้วยผลการวิเคราะห์ Ultra Advanced
"""
...
def generate_html_table(analyses, competition_name):
    ...
    # เรียงตามวันที่และเวลา และความมั่นใจ (เรียงจากมากไปน้อย)
    analyses.sort(key=lambda x: (x['kickoff_thai'], -x['match_result']['confidence']))
    ...
    for match in analyses:
        ...
        h2h_tooltip = f"H2H: {h2h['matches_count']} matches, {h2h['home_wins']}-{h2h['draws']}-{h2h['away_wins']}, Avg Goals: {h2h['avg_goals']:.1f}"
...
def generate_html_output(analysis_data):
    ...
    <head>
        <meta charset="UTF-8">
        <title>UEFA Competitions Ultra Advanced Analysis - July 17-18, 2025</title>
        <style>
            body {{
    ...
    <body>
        <h1>UEFA Competitions Ultra Advanced Analysis - July 17-18, 2025</h1>
        <p>Ultra Advanced ML analysis for UEFA Europa League and UEFA Europa Conference League matches</p>
        ...
        <div class="analysis-footer">
            ...
            <p>Analysis confidence: High (based on historical team performance data and Ultra Advanced ML)</p>
        </div>
    </body>
    </html>
    """
    
    with open('uefa_competitions_ultra_advanced_tables.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print(f"💾 บันทึก HTML ลงไฟล์: uefa_competitions_ultra_advanced_tables.html")
    return True
...
def update_index_html(analysis_data):
    ...
    try:
        ...
        uefa_section = f"""
        <!-- UEFA Competitions Ultra Advanced Analysis Section -->
        <div class="section-container">
            <div class="section-header">
                <h2>🇪🇺 UEFA Competitions Ultra Advanced Analysis - July 17-18, 2025</h2>
                <p class="section-description">Ultra Advanced ML analysis for UEFA Europa League and UEFA Europa Conference League matches</p>
            </div>
        ...
        <!-- End UEFA Competitions Ultra Advanced Analysis Section -->
        """
        
        # ตรวจสอบว่ามีส่วน UEFA อยู่แล้วหรือไม่
        if "<!-- UEFA Competitions Ultra Advanced Analysis Section -->" in html_content:
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 Update Index with Ultra Advanced Analysis - July 17-18, 2025")
    print("=" * 60)
    
    # รันสคริปต์วิเคราะห์ข้อมูล
    print("\n📊 กำลังรันสคริปต์วิเคราะห์ข้อมูล...")
    os.system("python analyze_uefa_with_ultra_advanced.py")
