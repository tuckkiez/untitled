#!/usr/bin/env python3
"""
🚀 Update Index with Real Data Analysis - July 17-18, 2025
อัปเดตหน้า index.html ด้วยผลการวิเคราะห์จากข้อมูลจริง
"""
...
def generate_html_output(analysis_data):
    ...
    with open('uefa_competitions_real_data_tables.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print(f"💾 บันทึก HTML ลงไฟล์: uefa_competitions_real_data_tables.html")
    return True
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 Update Index with Real Data Analysis - July 17-18, 2025")
    print("=" * 60)
    
    # รันสคริปต์วิเคราะห์ข้อมูล
    print("\n📊 กำลังรันสคริปต์วิเคราะห์ข้อมูล...")
    os.system("python analyze_uefa_with_real_data.py")
