...
อัพเดทไฟล์ index.html ด้วยข้อมูลการวิเคราะห์ China Super League รวมถึงการวิเคราะห์เตะมุม
"""
...
def create_china_super_league_section(df):
    ...
    for _, row in df.iterrows():
        ...
        # Format corners prediction
        corners_parts = row['corners'].split()
        corners_prediction = f"{corners_parts[0]} {corners_parts[1]}"
        ...
        <tr class="{row_class}">
            ...
            <td class="">{corners_prediction} ({row['corners_confidence']}%)</td>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="alert alert-info">
                ...
                <strong>NEW:</strong> China Super League analysis with Ultra Advanced ML, real-time data integration, and corner predictions.
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Changchun Yatai vs Shanghai Port</td>
                                            <td>Away Win @ 1.38</td>
                                            <td class="text-success">25.0%</td>
                                            <td>70.5%</td>
                                        </tr>
                                        <tr>
                                            <td>Tianjin Jinmen Tiger vs Chengdu Rongcheng</td>
                                            <td>Corners Under 10 @ 1.925</td>
