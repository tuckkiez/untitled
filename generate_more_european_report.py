...
# -*- coding: utf-8 -*-
"""
🚀 Additional European Leagues HTML Report Generator
สร้างรายงาน HTML สำหรับการวิเคราะห์ลีกยุโรปเพิ่มเติม
"""
...
def main():
    ...
    if not matches:
        print("No analysis data found. Please run analyze_more_european_leagues.py first.")
        return
