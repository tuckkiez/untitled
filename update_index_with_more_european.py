...
# -*- coding: utf-8 -*-
"""
🚀 Update Index with Additional European Leagues Analysis
อัพเดทหน้า index.html ด้วยการวิเคราะห์ลีกยุโรปเพิ่มเติม
"""
...
def main():
    ...
    if not more_european_soup:
        print("No additional European leagues HTML report found. Please run generate_more_european_report.py first.")
        return
