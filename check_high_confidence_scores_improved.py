#!/usr/bin/env python3
"""
🚀 Check High Confidence Scores (Improved) - July 17-18, 2025
ตรวจสอบการทำนายสกอร์ที่มีความมั่นใจ 80% ขึ้นไป (ปรับปรุง)
"""
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 Check High Confidence Scores (Improved) - July 17-18, 2025")
    print("=" * 60)
