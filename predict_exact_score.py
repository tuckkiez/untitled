#!/usr/bin/env python3
"""
🚀 Predict Exact Score - July 17-18, 2025
ทำนายสกอร์ที่มีความมั่นใจ 80% ขึ้นไป
"""
...
class ExactScorePredictor:
    ...
    def predict_exact_score(self, match):
        ...
        prediction = {
            ...
            'confidence': round(top_scores[0][1] * 100, 1)
        }
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 Predict Exact Score - July 17-18, 2025")
    print("=" * 60)
    ...
    try:
        ...
        with open('uefa_competitions_real_data_analysis_with_score.json', 'w', encoding='utf-8') as f:
            json.dump(analysis_data, f, ensure_ascii=False, indent=2)
        
        print(f"\n💾 บันทึกผลการวิเคราะห์ลงไฟล์: uefa_competitions_real_data_analysis_with_score.json")
