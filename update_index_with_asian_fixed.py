...
# -*- coding: utf-8 -*-
"""
🚀 Update Index with Asian Leagues Analysis (Fixed)
อัพเดทหน้า index.html ด้วยการวิเคราะห์ลีกเอเชีย (แก้ไขแล้ว)
"""
...
def main():
    ...
    if not asian_soup:
        print("No Asian leagues HTML report found. Please run generate_asian_report_fixed.py first.")
        return
