...
สร้างรายงาน HTML สำหรับการวิเคราะห์ China Super League
"""
        ...
        <div class="prediction-card">
            ...
            <table class="odds-table">
                ...
                <tr>
                    ...
                    <td>{row['odds_btts_yes']}</td>
                    <td>{row['odds_btts_no']}</td>
                </tr>
            </table>
        </div>
"""
...
def main():
    ...
    output_html = "/Users/80090/Desktop/Project/untitle/api_data/china_super_league/china_super_league_report_20250718.html"
