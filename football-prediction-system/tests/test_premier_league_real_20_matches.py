#!/usr/bin/env python3
"""
🏴󠁧󠁢󠁥󠁮󠁧󠁿 ทดสอบ Premier League Real Predictor
...
def test_premier_league_20_matches():
    """ทดสอบ Premier League 20 นัดล่าสุด"""
    print("🏴󠁧󠁢󠁥󠁮󠁧󠁿 ทดสอบ Premier League Real Predictor")
    print("📊 ทดสอบ 20 นัดล่าสุดด้วยข้อมูลจริง")
    print("=" * 70)
    
    # สร้าง predictor
    predictor = PremierLeagueRealPredictor()
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 Premier League Real Data Testing")
    print("🏴󠁧󠁢󠁥󠁮󠁧󠁿 ทดสอบด้วยข้อมูลจริง 380 เกม")
    print("=" * 70)
    
    # ทดสอบระบบ
    result = test_premier_league_20_matches()
    
    if result:
        print(f"\n🎉 การทดสอบเสร็จสิ้น!")
        print(f"📊 ระบบ Premier League ด้วยข้อมูลจริงพร้อมใช้งาน")
