#!/usr/bin/env python3
"""
Helper methods สำหรับ Premier League Real Predictor
"""
...
def add_helper_methods_to_premier_league():
    """เพิ่ม helper methods เข้าไปใน PremierLeagueRealPredictor"""
    from premier_league_real_predictor import PremierLeagueRealPredictor
    
    PremierLeagueRealPredictor._create_prediction_features = _create_prediction_features
    PremierLeagueRealPredictor._ensemble_predict = _ensemble_predict
    PremierLeagueRealPredictor._ensemble_predict_proba = _ensemble_predict_proba
    PremierLeagueRealPredictor._get_recent_form = _get_recent_form
    PremierLeagueRealPredictor._get_season_form = _get_season_form
    PremierLeagueRealPredictor._get_head_to_head = _get_head_to_head
    PremierLeagueRealPredictor._get_home_away_form = _get_home_away_form
    PremierLeagueRealPredictor._calculate_momentum = _calculate_momentum
    PremierLeagueRealPredictor._days_since_last_match = _days_since_last_match
    PremierLeagueRealPredictor._get_league_position = _get_league_position

if __name__ == "__main__":
    add_helper_methods_to_premier_league()
    print("✅ เพิ่ม helper methods สำหรับ Premier League สำเร็จ")
