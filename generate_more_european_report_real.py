...
# -*- coding: utf-8 -*-
"""
🚀 Additional European Leagues HTML Report Generator (Real Data)
สร้างรายงาน HTML สำหรับการวิเคราะห์ลีกยุโรปเพิ่มเติมด้วยข้อมูลจริง
"""
...
def main():
    ...
    if not matches:
        print("No analysis data found. Please run analyze_more_european_leagues_real.py first.")
        return
