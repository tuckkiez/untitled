#!/usr/bin/env python3
"""
🚀 Update Index with UEFA Advanced ML Analysis - July 17-18, 2025
สร้างตารางแสดงผลการวิเคราะห์และอัปเดตหน้า index.html
"""
...
def load_analysis_data():
    ...
    try:
        with open('uefa_competitions_advanced_ml_analysis.json', 'r', encoding='utf-8') as f:
            return json.load(f)
...
def generate_html_output(analysis_data):
    ...
    <head>
        <meta charset="UTF-8">
        <title>UEFA Competitions Advanced ML Analysis - July 17-18, 2025</title>
        <style>
            body {{
    ...
    <body>
        <h1>UEFA Competitions Advanced ML Analysis - July 17-18, 2025</h1>
        ...
        <div class="analysis-footer">
            ...
            <p>Analysis confidence: High (based on historical team performance data and Advanced ML)</p>
        </div>
    </body>
    </html>
    """
    
    with open('uefa_competitions_advanced_ml_tables.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print(f"💾 บันทึก HTML ลงไฟล์: uefa_competitions_advanced_ml_tables.html")
    return True
...
def update_index_html(analysis_data):
    ...
    try:
        ...
        uefa_section = f"""
        <!-- UEFA Competitions Advanced ML Analysis Section -->
        <div class="section-container">
            <div class="section-header">
                <h2>🇪🇺 UEFA Competitions Advanced ML Analysis - July 17-18, 2025</h2>
        ...
        <!-- End UEFA Competitions Advanced ML Analysis Section -->
        """
        
        # ตรวจสอบว่ามีส่วน UEFA อยู่แล้วหรือไม่
        if "<!-- UEFA Competitions Advanced ML Analysis Section -->" in html_content:
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 Update Index with UEFA Advanced ML Analysis - July 17-18, 2025")
    print("=" * 60)
    
    # รันสคริปต์วิเคราะห์ข้อมูล
    print("\n📊 กำลังรันสคริปต์วิเคราะห์ข้อมูล...")
    os.system("python uefa_advanced_ml_analyzer.py")
