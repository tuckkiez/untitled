#!/usr/bin/env python3
"""
🚀 Update Index with Current Data - July 17-18, 2025
อัปเดตหน้า index.html ด้วยข้อมูลที่มีอยู่แล้ว
"""
...
def generate_html_output(analysis_data):
    ...
    with open('uefa_competitions_real_data_tables_current.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print(f"💾 บันทึก HTML ลงไฟล์: uefa_competitions_real_data_tables_current.html")
    return True
...
def main():
    """ฟังก์ชันหลัก"""
    print("🚀 Update Index with Current Data - July 17-18, 2025")
    print("=" * 60)
