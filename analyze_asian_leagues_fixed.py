...
# -*- coding: utf-8 -*-
"""
🚀 Ultra Advanced ML Football Analysis for Asian Leagues (Fixed)
วิเคราะห์การแข่งขันฟุตบอลลีกเอเชียด้วย Ultra Advanced ML (แก้ไขแล้ว)
"""
            ...
            with open('today_fixtures.json', 'r') as f:
                ...
                for fixture in fixtures_data.get("response", []):
                    ...
                    if (league_country == "China" and league_name == "Super League") or \
                       ...
                       (league_country == "South-Korea" and (league_name == "K League 1" or league_name == "K League 2")):
...
def get_asian_fixtures():
    """Get Asian fixtures from today's fixtures data"""
    fixtures = []
    
    # China Super League
    fixtures.extend([
        {"home_team": "Dalian Zhixing", "away_team": "Shandong Luneng", "league": "China - Super League", "time": "18:00"},
        {"home_team": "Sichuan Jiuniu", "away_team": "Qingdao Jonoon", "league": "China - Super League", "time": "18:35"},
        {"home_team": "Beijing Guoan", "away_team": "Shanghai Shenhua", "league": "China - Super League", "time": "18:35"},
        {"home_team": "Henan Jianye", "away_team": "Meizhou Kejia", "league": "China - Super League", "time": "19:00"}
    ])
    
    # Japan J1 League
    fixtures.extend([
        {"home_team": "FC Tokyo", "away_team": "Urawa", "league": "Japan - J1 League", "time": "17:00"},
        {"home_team": "Shonan Bellmare", "away_team": "Cerezo Osaka", "league": "Japan - J1 League", "time": "17:00"}
    ])
    
    # South Korea K League 1
    fixtures.extend([
        {"home_team": "Gangwon FC", "away_team": "Daejeon Citizen", "league": "South-Korea - K League 1", "time": "17:00"},
        {"home_team": "Pohang Steelers", "away_team": "Jeonbuk Motors", "league": "South-Korea - K League 1", "time": "17:00"},
        {"home_team": "Jeju United FC", "away_team": "FC Anyang", "league": "South-Korea - K League 1", "time": "17:00"}
    ])
    
    # South Korea K League 2
    fixtures.extend([
        {"home_team": "Jeonnam Dragons", "away_team": "Suwon Bluewings", "league": "South-Korea - K League 2", "time": "17:00"},
        {"home_team": "Gimpo Citizen", "away_team": "Ansan Greeners", "league": "South-Korea - K League 2", "time": "17:00"},
        {"home_team": "Seoul E-Land FC", "away_team": "Seongnam FC", "league": "South-Korea - K League 2", "time": "17:00"},
        {"home_team": "Hwaseong", "away_team": "Busan I Park", "league": "South-Korea - K League 2", "time": "17:00"}
    ])
