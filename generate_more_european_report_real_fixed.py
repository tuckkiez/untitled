...
# -*- coding: utf-8 -*-
"""
🚀 Additional European Leagues HTML Report Generator (Real Data, Fixed)
สร้างรายงาน HTML สำหรับการวิเคราะห์ลีกยุโรปเพิ่มเติมด้วยข้อมูลจริงและเวลาไทย
"""
...
def load_analysis_data():
    ...
    try:
        with open('more_european_leagues_analysis.json', 'r') as f:
            return json.load(f)
    except:
...
<head>
    ...
    <title>🏆 Additional European Leagues Analysis - July 19, 2025</title>
...
<div class="container py-4">
    <div class="header">
        <h1>🏆 Additional European Leagues Analysis - July 19, 2025</h1>
...
"""
    ...
    for league_name, league_matches in matches_by_league.items():
        ...
        if "Norway" in league_name:
            flag_emoji = "🇳🇴"
        elif "Sweden" in league_name:
            flag_emoji = "🇸🇪"
        elif "Poland" in league_name:
            flag_emoji = "🇵🇱"
        elif "Iceland" in league_name:
            flag_emoji = "🇮🇸"
        elif "Denmark" in league_name:
            flag_emoji = "🇩🇰"
        elif "Finland" in league_name:
            flag_emoji = "🇫🇮"
...
def save_html_report(html_content, filename="more_european_leagues_report.html"):
...
def main():
    ...
    if not matches:
        print("No analysis data found. Please run analyze_more_european_leagues_real_fixed2.py first.")
        return
